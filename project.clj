...
(defproject hexagram30/janusgraph-db-plugin "0.1.0-SNAPSHOT"
  :description "A hexagram30 db plugin for the janusgraph db"
  :url "https://github.com/hexagram30/janusgraph-db-plugin"
  :license {
  ...
  :profiles {
    ...
    :dev {
      ...
      :repl-options {
        :init-ns hxgm30.db.plugin.janusgraph.repl
        :prompt ~get-prompt
